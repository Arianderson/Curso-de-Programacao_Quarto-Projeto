...
<body style="background-color: #d0c1d3;">
    ...
    <!--Div Principal-->
    <div style="width:70%; height:85%; background-color: transparent; margin: auto; border-radius: 3%;">
        <!--Div da Esquerda (Menu Horizontal)-->
        <div style="width:15%;height:100%; background-color:#161616; border-top-left-radius:30px;border-bottom-left-radius:30px; float: left;">
            ...
            <div style="width:100%; height: 26%; background-color:#161616; text-align: center;">
                ...
                <br />
                <span style="font-size: 13pt; font-family:'futura'; color: #ffffff;"><b>Ari Sena</b></span>
            </div>
            ...
            <!--Quarta Div Maps-->
            <div style="width:100%; height: 35%; background-color:#161616; border-bottom-left-radius:30px; text-align: center;">
        ...
        <!--Div da Direita-->
        <div style="width:85%; height:100%; background-color: #ffffff ; float: right; border-bottom-right-radius:30px; border-top-right-radius:30px;">
            ...
            <div style="width:85%; height:100%; background-color:#ffffff; margin: auto;">
                ...
                <div style="width:100%; height:12%; background-color:#ffffff;">
                    ...
                    <!--Div da distância-->
                    <div style="width: 20%; height: 100%; background-color: #ffffff; float: right;">
                        <div style="width: 70%; height: 50%; background-color: #ffffff; margin: auto; text-align: center;">
                            <div style="width:35%; height:50%; background-color: #ffffff; margin: auto; border-radius: 30%; text-align: center;">
                                <b>4 km</b>
                            </div>
                            <div style="width: 100%; height: 50%; background-color: #ffffff;">
                                <img src="img/icons/percurso.png" alt="percurso" width="120px" height="20px">
                            </div>
                        </div>
                    </div>
                    <!--fim da div-->
                ...
                <div style="width:100%; height:43%; background-color:#ffffff; text-align: center;">

                    <!--Div principal do primeiro prato-->
                    <div style="width:25%; height: 100%; background-color:#ffffff; float: left;">
